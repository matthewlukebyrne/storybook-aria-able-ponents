...
export const TEXTBOX_MODIFIERS = {
    small: () => `
...
export const TextboxPrimary = styled(Textbox)`
    ...
    ${applyStyleModifiers(TEXTBOX_MODIFIERS)}
`;


// Inheritance from the previous styled element
export const TextboxSecondary = styled(Textbox)`
    background: none;
...
// Inheritance from the previous styled element
export const TextboxTeritary = styled(Textbox)`
    background: none;
    border: none;
    color: ${props => props.theme.primaryColor};
